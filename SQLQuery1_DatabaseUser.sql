...
-- Назначение ролей (предполагается, что роли уже созданы)
ALTER ROLE role_Client ADD MEMBER ClientUser;
ALTER ROLE role_RepairSpecialist ADD MEMBER RepairUser;
